    ...
    return(
        <>
            ...
            <Panel
                ...
                Nama "Almaty" berasal dari kata <span lang="kk-KZ">anma</span>, dalam bahasa Kazakh yang berarti "apel" dan asal usul apel, dan <i lang="la">Malus sieversii</i> liar dianggap sebagai kandidat yang mungkin menjadi nenek moyang apel domestik modern.
            </Panel>
        </>
    )
}
